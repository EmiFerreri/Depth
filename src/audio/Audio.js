...
export class Audio {
  ...
  play(type, combo = 1) {
    ...
    if (/^pad[123]$/.test(type)) {
      const count = Number(type.slice(-1));
      for (let i = 0; i < count; i++) this.tone([262, 330, 392][count - 1], i * 0.19);
      return;
    }
    const tones = { jump: 220, dash: 110, shard: 460 + combo * 28, boost: 660, rail: 330, hit: 70, enemy: 150, checkpoint: 880, finish: 1046, shield: 520, gravity: 390, clue: 523, echo: 784, 'puzzle-solved': 1046, 'puzzle-wrong': 98 };
