...
export const MODES = Object.freeze({
  story: { name: 'HISTORIA', sectors: 1, seed: 'ECOS-DE-TI', description: '100 cámaras · 10 capítulos. Recupera los recuerdos de Luma y aprende nuevas reglas.' },
  expedition: { name: 'EXPEDICIÓN', sectors: 1, seed: 'LUMA', description: 'Rutas por código, retos del día y de la semana. Elige intensidad y longitud.' },
